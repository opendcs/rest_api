Feature: Sources Page Functionality
  ...
  So that I can create, retrieve, update and delete sources data
  ...
  Scenario: Creating a new sources
    ...
    And I receive a confirmation message to save the sources
    And I click Yes in the message
    Then I should receive a message that my sources is saved successfully
    And I click on the OK button in the message
    And the new sources should be added to the Sources page

  Scenario: Access the Sources editor for a sources
  ...
  Scenario: Editing the information for a sources
    When I click on an existing row in the Sources page
  ...
  Scenario: Deleting a row
    ...
    And I receive a confirmation message to delete the sources
    And I click the Yes button in the confirmation message
    Then I should receive a message that the sources is successfully deleted
    And I click OK in the message
    And the sources should be removed from the Sources page