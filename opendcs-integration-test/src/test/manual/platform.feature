Feature: Platform Page Functionality

  As a user of the OpenDCS Web Client
  I want to test the Platform page
  ...
  Scenario: Configuring the Transport Media table
    Given I am on the Platform page
    When Click the Plus button in the Transport Media table. and  and The Transport Medium editor should be loaded. and  and Enter content for the General Details section. and  and When applicable, configure the information for parameters based on the selected Medium Type.
  ...
  Scenario: Creating a new row
    Given I am on the Platform page
    When Access the Platforms editor. and  and Configure the information needed in the Platform editor. and  and Observe any changes to the Platforms page.
  ...
  Scenario: Copying an existing entry
    Given I am on the Platform page
    When Click on the menu icon under the Actions column and select the Copy option. and The Platforms editor should load. and Observe the content in the Platforms editor. and Configure the information for the copied platform. and Observe any changes to the table.
    Then After selecting the Copy action, the Platforms editor should be loaded with the information for the selected row in the table. Edits made in the Platforms editor should be reflected in the Platforms table after clicking the Save button in the editor.
