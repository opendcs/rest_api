...
{
	@Schema(description = "The standard name of the data type.")
	private String dataTypeStd = null;

	@Schema(description = "The code representing the data type.")
	private String dataTypeCode = null;

	@Schema(description = "The units of the data.")
	private String units = null;

	@Schema(description = "The number of fractional digits to use, default is 2.", example = "2")
	private int fractionalDigits = 2;

	@Schema(description = "The minimum allowable value for the data.")
	private Double min = null;

	@Schema(description = "The maximum allowable value for the data.")
