...
{
	@Schema(description = "Unique identifier for the site.", example = "12345")
	...
	@Schema(description = "Map containing site names where the key represents the name type and the value the actual name.",
			example = "{\"official\": \"Main Site\", \"alias\": \"Site123\"}")
	private Map<String, String> sitenames = new HashMap<>();

	@Schema(description = "Public name for the site.", example = "Main Site", nullable = true)
	private String publicName = null;

	@Schema(description = "Description of the site.", example = "This is the main public water site.", nullable = true)
